...
#
# The original license is at `lib/utils/geometry/rotation.LICENSE`.
#
...
def axis_angle_to_quaternion(axis_angle: torch.Tensor) -> torch.Tensor:
    ...
    Returns:
        quaternions with real part first, as tensor of shape (..., 4). The form is (w, x, y, z).
    """
...
def quat_wxyz_to_xyzw(quat: torch.Tensor) -> torch.Tensor:
    ...
    PyTorch3D (here) uses (w, x, y, z) format.
...
def quat_xyzw_to_wxyz(quat: torch.Tensor) -> torch.Tensor:
    ...
    Args:
        quat: Quaternions with real part last,
            as tensor of shape (..., 4).
